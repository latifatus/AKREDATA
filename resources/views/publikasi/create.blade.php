...
@section('title','Tambah Publikasi Dosen')
...
<div class="bg-gradient-to-b from-[#d3f3e1] to-[#caf0d9] rounded-3xl shadow-md p-8">
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-emerald-800/70 text-sm mt-1 font-light">
                Tambahkan data publikasi kolaborasi dosen Program Studi.
            </p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-emerald-900/10 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-[#042E1F] to-[#0c4430] px-8 py-4 text-white">
            <h2 class="text-sm font-bold tracking-tight">📚 Formulir Publikasi Dosen</h2>
            <p class="text-xs text-green-300/80 font-light mt-0.5">Lengkapi informasi jurnal atau publikasi ilmiah kolaborasi dosen.</p>
        </div>

        {{-- Form --}}
        <form action="{{ route('publikasi.store') }}" method="POST" class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="nama_dosen_ti"
                        value="{{ old('nama_dosen_ti') }}"
                        placeholder="Masukkan nama dosen TI"
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('dosen_kolaborasi') }}"
                        placeholder="Masukkan nama dosen kolaborasi"
                        class="w-full border border-emerald-900/20 bg-emerald-50/20 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#042E1F] focus:bg-white focus:outline-none transition">
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="Cth: Universitas Malikussaleh"
                        class="w-full border border-emerald-900/20 bg-emerald-50/20 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#042E1F] focus:bg-white focus:outline-none transition">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        name="judul"
                        rows="3"
                        placeholder="Masukkan judul artikel / publikasi ilmiah..."
                        class="w-full border border-emerald-900/20 bg-emerald-50/20 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#042E1F] focus:bg-white focus:outline-none transition resize-none">{{ old('judul') }}</textarea>
